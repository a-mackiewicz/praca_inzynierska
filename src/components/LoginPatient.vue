                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group mb-2">
                                                <div class="input-group-prepend">
                                                    <div id="inputLogin" class="input-group-text">PESEL:</div>
                                                </div>
                                                <input type="text" class="form-control" v-model="login.pesel" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                        <div class="col-sm-12">
                                            <div class="input-group mb-2"> 
                                                <div class="input-group-prepend">
                                                    <div id="inputPass" class="input-group-text">KOD:</div>
                                                </div>
    ...
    export default {
        ...
        mounted(){
            ...
            if(this.$cookies.get('user')) {
                    this.$router.push('/patient_panel')
            } else {
                this.$parent.navState = 1;
                this.$parent.changeLoginType();
            }
        },
        methods: {
            loginUser() {
                let apiURL = 'http://localhost:4000/api/login-patient';
